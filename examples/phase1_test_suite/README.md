...
The suite covers OpenZeppelin v5-compatible explicit ERC profiles:
...
ERC-777 is intentionally excluded from the Solidity contract suite because
OpenZeppelin Contracts v5 no longer ships an `ERC777` implementation. Historical
ERC-777 generated artifacts may be kept separately for knowledge-base and
fallback-profile analysis, but they are not part of the v5 compilation set.
