...
<div style="text-align: center; display: flex; flex-direction: column; align-items: center; gap: 1.5rem;" markdown>

[ 🤍 Make your Donation ](https://owasp.org/donate/?reponame=owasp-scs&title=OWASP+Smart+Contract+Security){ .md-button .md-button--primary .pump style="margin: 5px;" }
...
[ :material-check-all: Register your Donation ](https://github.com/OWASP/owasp-scs/issues/new?assignees=warlordsam07&labels=org%2Cdonation&template=make-donation.yml&title=%F0%9F%92%B2%F0%9F%8E%89+New+Donation){ .md-button .md-button--primary style="margin: 5px;" }
